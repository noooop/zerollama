...
- b. 提示词长度 8-32 之间，相同模型的不同量化版本，速度差异很大，不同量化方法带宽瓶颈切换到算力瓶颈情况不一样 
...
> 
> - q5_k_m 最快，q6_k 最慢， Latency 排名基本上跟 BPW 没啥关系，可能是不同量化版本计算和带宽比不同「意味がぜんぜんわからない」


- c. 32 之后，相同模型的不同量化版本又基本相同，完全切换到算力瓶颈
