...
from zerollama.tasks.qa.protocol import PROTOCOL
from zerollama.tasks.qa.protocol import QAModelConfig


class QAModel(ModelBase):
    protocol = PROTOCOL
    ...
    def get_model_config(cls, model_name):
        ...
        return QAModelConfig(**model_config)


class QAGGUFModel(QAModel):
